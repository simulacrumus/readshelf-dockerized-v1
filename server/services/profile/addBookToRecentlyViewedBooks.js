...
exports.addBookToRecentlyViewedBooks = async (req, res) => {
    ...
    try {
        ...
        if (!profile.recentlyViewedBooks.some(book => book.googleApiId === googleApiId)){
            ...
            profile = await Profile.findOneAndUpdate(
                ...
                {
                    $addToSet: {recentlyViewedBooks: addedBook._id}
                },{
                    upsert: true,
                    new: true
                }
        ...
        profile.recentlyViewedBooks.sort((x,y) => { return x.googleApiId == googleApiId ? 1 : y.googleApiId == googleApiId ? -1 : 0; })
